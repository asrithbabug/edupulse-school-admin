    ...
    <div className="space-y-6 max-w-4xl">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-2xl font-bold text-text-primary">New Admission</h2>
            <p className="text-text-secondary text-sm mt-0.5">Register a fresh student — fill all required fields</p>
          </div>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="bg-white rounded-xl border border-border p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <Field label="Admission Seeking for Class" required>
            ...
            <Field label="Admission No" error={errors.admissionNo}>
              <input
                type="text"
                value={formData.admissionNo || 'Auto-generated after submission'}
                readOnly
                disabled
            ...
            <Field label="Admission Date" required error={errors.admissionDate}>
              <input type="date" value={formData.admissionDate} onChange={e => handleChange('admissionDate', e.target.value)}
                className={`input-field ${errors.admissionDate ? 'border-red-400' : ''}`} />
            </Field>
            <Field label="Medium">
